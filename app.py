...
if menu == "Introduktion":
    ...
    st.dataframe(feat_importance.reset_index().rename(columns={'index': 'Feature', 0: 'Importance (%)'}).style.background_gradient(cmap='YlGn'))
